...
protected:
    std::shared_ptr<mock_Texture> pt{std::make_shared<mock_Texture>()};
    mock_SpriteAnimated s{
        SpriteAnimated::SpriteAnimatedBuilder{-1, pt, RECT_FULL, 4, 2, false, 8, 8, IndexTimer::K11_BOMB}};
    mock_SpriteAnimated ss{
        SpriteAnimated::SpriteAnimatedBuilder{-1, pt, RECT_FULL, 8, 4, false, 8, 8, IndexTimer::K11_BOMB}};
...
protected:
    ...
    mock_SpriteNumber s1{SpriteNumber::SpriteNumberBuilder{-1, pt, Rect(0, 0, 100, 160), 2, 5, false, 1, 0,
                                                           IndexTimer::SCENE_START, NumberAlign::NUM_ALIGN_LEFT, 1,
                                                           IndexNumber::_TEST1}}; // 20,80
    mock_SpriteNumber s{SpriteNumber::SpriteNumberBuilder{-1, pt, Rect(0, 0, 100, 160), 2, 5, false, 1, 0,
                                                          IndexTimer::SCENE_START, NumberAlign::NUM_ALIGN_LEFT, 4,
                                                          IndexNumber::_TEST1}}; // 20,80
    mock_SpriteNumber sa{SpriteNumber::SpriteNumberBuilder{-1, pt, Rect(0, 0, 100, 160), 4, 5, false, 2, 2,
                                                           IndexTimer::K11_BOMB, NumberAlign::NUM_ALIGN_LEFT, 4,
                                                           IndexNumber::_TEST1}}; // 20,40
    mock_SpriteNumber s11{SpriteNumber::SpriteNumberBuilder{-1, pt, Rect(0, 0, 110, 160), 1, 11, false, 1, 0,
                                                            IndexTimer::SCENE_START, NumberAlign::NUM_ALIGN_LEFT, 4,
                                                            IndexNumber::_TEST1}}; // 10,160
    mock_SpriteNumber sa11{SpriteNumber::SpriteNumberBuilder{-1, pt, Rect(0, 0, 110, 160), 4, 11, false, 4, 4,
                                                             IndexTimer::K11_BOMB, NumberAlign::NUM_ALIGN_LEFT, 4,
                                                             IndexNumber::_TEST1}}; // 10,40
    mock_SpriteNumber s24{SpriteNumber::SpriteNumberBuilder{-1, pt, Rect(0, 0, 240, 160), 2, 12, false, 1, 0,
                                                            IndexTimer::SCENE_START, NumberAlign::NUM_ALIGN_LEFT, 4,
                                                            IndexNumber::_TEST1}}; // 20,80
    mock_SpriteNumber sa24{SpriteNumber::SpriteNumberBuilder{-1, pt, Rect(0, 0, 240, 160), 8, 12, false, 4, 4,
                                                             IndexTimer::K11_BOMB, NumberAlign::NUM_ALIGN_LEFT, 4,
                                                             IndexNumber::_TEST1}}; // 20,30
    mock_SpriteNumber sr{SpriteNumber::SpriteNumberBuilder{-1, pt, Rect(0, 0, 110, 160), 1, 11, false, 1, 0,
                                                           IndexTimer::SCENE_START, NumberAlign::NUM_ALIGN_RIGHT, 4,
                                                           IndexNumber::_TEST1}}; // 10,160
    mock_SpriteNumber sc{SpriteNumber::SpriteNumberBuilder{-1, pt, Rect(0, 0, 110, 160), 1, 11, false, 1, 0,
                                                           IndexTimer::SCENE_START, NumberAlign::NUM_ALIGN_CENTER, 4,
                                                           IndexNumber::_TEST1}}; // 10,160
public:
    sNumber()
    {
...
protected:
    std::shared_ptr<mock_Texture> pt{std::make_shared<mock_Texture>()};
    mock_SpriteSlider sL{SpriteSlider::SpriteSliderBuilder{
        -1,
        pt,
        TEST_RECT,
        1,
    ...
    mock_SpriteSlider sR{SpriteSlider::SpriteSliderBuilder{
        -1,
        pt,
        TEST_RECT,
        1,
    ...
    mock_SpriteSlider sU{SpriteSlider::SpriteSliderBuilder{
        -1,
        pt,
        TEST_RECT,
        1,
    ...
    mock_SpriteSlider sD{SpriteSlider::SpriteSliderBuilder{
        -1,
        pt,
        TEST_RECT,
        1,
...
protected:
    std::shared_ptr<mock_Texture> pt{std::make_shared<mock_Texture>()};
    mock_SpritIndexBargraph sL{SpriteBargraph::SpriteBargraphBuilder{
        -1, pt, TEST_RECT, 1, 1, false, 1, 0, IndexTimer::K11_BOMB, BargraphDirection::LEFT, IndexBargraph::_TEST1}};
    mock_SpritIndexBargraph sR{SpriteBargraph::SpriteBargraphBuilder{
        -1, pt, TEST_RECT, 1, 1, false, 1, 0, IndexTimer::K11_BOMB, BargraphDirection::RIGHT, IndexBargraph::_TEST1}};
    mock_SpritIndexBargraph sU{SpriteBargraph::SpriteBargraphBuilder{
        -1, pt, TEST_RECT, 1, 1, false, 1, 0, IndexTimer::K11_BOMB, BargraphDirection::UP, IndexBargraph::_TEST1}};
    mock_SpritIndexBargraph sD{SpriteBargraph::SpriteBargraphBuilder{
        -1, pt, TEST_RECT, 1, 1, false, 1, 0, IndexTimer::K11_BOMB, BargraphDirection::DOWN, IndexBargraph::_TEST1}};
...
protected:
    ...
    mock_SpriteOption ss0{
        SpriteOption::SpriteOptionBuilder{-1, pt, RECT_FULL, 1, 1, false, 1, 1, IndexTimer::K11_BOMB}};
...
protected:
    std::shared_ptr<mock_Texture> pt{std::make_shared<mock_Texture>()};
    mock_SpriteGaugeGrid s1{SpriteGaugeGrid::SpriteGaugeGridBuilder{-1, pt, Rect(0, 0, 40, 40), 1, 4, false, 1, 0,
                                                                    IndexTimer::K11_BOMB, 10, 0, 0, 100, 50,
                                                                    IndexNumber::PLAY_1P_GROOVEGAUGE}};
    mock_SpriteGaugeGrid s2{SpriteGaugeGrid::SpriteGaugeGridBuilder{-1, pt, Rect(0, 0, 60, 40), 1, 6, false, 1, 0,
                                                                    IndexTimer::K11_BOMB, -10, 0, 0, 100, 50,
                                                                    IndexNumber::PLAY_2P_GROOVEGAUGE}};
