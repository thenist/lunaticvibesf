...
static constexpr const char* s_select_diff[] = {"ALL", "BEGINNER", "NORMAL", "HYPER", "ANOTHER", "INSANE"};
...
static constexpr const char* s_select_sort[] = {"FOLDER", "LEVEL", "TITLE", "CLEAR", "INSANE"};
...
static constexpr const char* s_filter_keys[] = {"ALL KEYS", "SINGLE", "7KEYS",  "5KEYS",
                                                "DOUBLE",   "14KEYS", "10KEYS", "9BUTTONS"};
...
static constexpr const char* s_bga_type[] = {"OFF", "ON", "AUTOPLAY"};
...
static constexpr const char* s_lane_effect_type[] = {
    "OFF", "HIDDEN+", "SUDDEN+", "SUD+&HID+", "LIFT", "LIFT&SUD+",
};
...
static constexpr const char* s_speed_type[] = {"OFF",      "MIN FIX",   "MAX FIX", "AVERAGE",
                                               "CONSTANT", "START FIX", "MAIN FIX"};
...
static constexpr const char* s_battle_type[] = {
    "OFF", "BATTLE", "D-BATTLE", "SP to DP", "GHOST",
};
...
static constexpr const char* s_gauge_type[] = {
    "NORMAL", "HARD", "DEATH", "EASY", "PATK_NOT_IMPLEMENTED", "GATK_NOT_IMPLEMENTED", "EX-HARD", "ASSIST-EASY",
};
...
static constexpr const char* s_random_type[] = {"NORMAL",  "MIRROR",   "RANDOM",      "S-RANDOM", "H-RANDOM",
                                                "ALL-SCR", "R-RANDOM", "SYNCHRONIZE", "SYMMETRY"};
static constexpr const char* s_random_type_short[] = {"",        "MIR",   "RAN", "S-RAN", "H-RAN",
                                                      "ALL-SCR", "R-RAN", "SYN", "SYM"};
